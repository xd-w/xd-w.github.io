...
My research fields are Artificial Intelligence (AI) and Machine Learning (ML). My PhD research fields are Artificial Intelligence (AI) and Machine Learning (ML), with a focus on the topics of Graph Learning and Smart Grid; And My PhD supervisors are [Prof. Chris Ding](https://sds.cuhk.edu.cn/en/teacher/197) [[Google Scholar](https://scholar.google.com/citations?user=q7FfnjgAAAAJ&hl=zh-CN&oi=ao)] and [Prof. Tongxin Li](https://tongxin.me).
