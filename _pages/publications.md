...
<div class="academic-list">
  <article>
    <p class="academic-list__venue">PhD Dissertation</p>
    <h2>Principled and Effective Graph Representation Learning with Application to Anomaly Detection</h2>
    <p>理论驱动的高效图表示学习及其在异常检测中的应用</p>
    <p><strong>Recommended citation:</strong> GB/T 7714 Wang Xudong. Principled and Effective Graph Representation Learning with Application to Anomaly Detection[D]. The Chinese University of Hong Kong, Shenzhen, 2026.</p>
  </article>
</div>

<h2 class="archive__subtitle">Papers and Patents</h2>
...
<div class="academic-list">
  ...
  <article>
    <p class="academic-list__venue">AAAI 2026</p>
    <h2><a href="https://ojs.aaai.org/index.php/AAAI/article/view/39869">Adaptive Riemannian Graph Neural Networks</a></h2>
    <p><strong>Xudong Wang</strong>, Tongxin Li, Chris Ding, Jicong Fan.</p>
    <p>The 40th Annual AAAI Conference on Artificial Intelligence.</p>
  </article>
  ...
  <article>
    <p class="academic-list__venue">ACM e-Energy 2022</p>
    <h2><a href="https://dl.acm.org/doi/10.1145/3538637.3538860">EVSense: a robust and scalable approach to non-intrusive EV charging detection</a></h2>
    <p><strong>Xudong Wang</strong>, Guoming Tang, Yi Wang, Srinivasan Keshav, Yu Zhang.</p>
    <p>The 13th ACM SIGEnergy International Conference on Future Energy Systems.</p>
  </article>
  ...
  <article>
    <p class="academic-list__venue">Patent</p>
    <h2>一种电动汽车充电监测方法及系统</h2>
    <p>Inventors: Yangjing Wu; <strong>Xudong Wang</strong>.</p>
    <p>Patent no. CN202210620528, ICPC H02J3/00.</p>
  </article>
</div>
